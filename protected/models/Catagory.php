...
class Catagory extends CActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			array('categoryname, categorydesc, priority, parentcategoryid', 'required'),
			...
			array('id, categoryname, categorydesc, priority, parentcategoryid, isactive, isfeatured', 'safe', 'on'=>'search'),
		);
	}
