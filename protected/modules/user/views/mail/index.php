...
function sendmail(type){
    $.post("<?php echo Yii::app()->getBaseUrl(true);?>/user/mail/sendmail",{type:type},function(res){
           alert('Mail sent successfully');
    });
}
</script>
<p style="width:580px;margin:0 auto; margin-bottom: 10px; text-align: center;">If Images Are Not Displaying, Please <a href="https://purchasesecure.org/11006?affid=2021&subid=listname" target="_blank" style="text-decoration:none; font-family:Arial, Helvetica, sans-serif; font-size:16px;">Visit Here</a></p>
...
<div style="margin: 20px auto;width:580px;"><input type="button" value="Send Mail" onclick="sendmail(1)"></div>


<p style="width:580px;margin:0 auto; margin-bottom: 10px; text-align: center;">If Images Are Not Displaying, Please <a href="https://purchasesecure.org/garstr101?affid=2021&subid=listname" target="_blank" style="text-decoration:none; font-family:Arial, Helvetica, sans-serif; font-size:16px;">Visit Here</a></p>
...
<div style="margin: 20px auto;width:580px;"><input type="button" value="Send Mail" onclick="sendmail(2)"></div>



<p style="width:580px;margin:0 auto; margin-bottom: 10px; text-align: center;">If Images Are Not Displaying, Please <a href="http://smttrack.com/?a=33&c=342&s1=" target="_blank" style="text-decoration:none; font-family:Arial, Helvetica, sans-serif; font-size:16px;">Visit Here</a></p>
...
<div style="margin: 20px auto;width:580px;"><input type="button" value="Send Mail" onclick="sendmail(3)"></div>


<p style="width:580px;margin:0 auto; margin-bottom: 10px; text-align: center;">If Images Are Not Displaying, Please <a href="http://pacificmarketing.go2cloud.org/aff_c?offer_id=6&aff_id=1000&aff_sub=112" target="_blank" style="text-decoration:none; font-family:Arial, Helvetica, sans-serif; font-size:16px;">Visit Here</a></p>
...
<div style="margin: 20px auto;width:580px;"><input type="button" value="Send Mail" onclick="sendmail(4)"></div>
