...
<div class="video-container">
	...
	<img src="<?php echo $themeUrl?>/images/video-img.png" alt="Search engine friendly content">
    </a>
...
<div class="image-contain">
 ...
 <li><a href="range.php" style="color: #fff;"><img src="<?php echo $themeUrl?>/images/img1.png" alt="#" />
 Shooting Range</a>
 
 </li>
  <li><a href="venue.php" style="color: #fff;"><img src="<?php echo $themeUrl?>/images/new-img1.png" alt="#" />
    Venue</a>
  </li>
   <li style="margin-right:0;"><a href="studio.php" style="color: #fff;"><img src="<?php echo $themeUrl?>/images/new-img2.png" alt="#" />
     Studio</a>
   </li>
 </ul>
