...
class Admin_NewsletterController extends MyController
{


    public function init()
    {
        $this->pageTitle="Newslwtter Manager";//assign title of every page in this controller
    ...
    {
        $this->redirect(yii::app()->baseurl."/product/admin/newsletter/listing");
    }
    ...
    public function actionListing()
    {
        ...
        {
            $model->user_id=$_GET['Newsletter']['user_id'];
            $model->userid=$_GET['Newsletter']['userid'];
            $model->email=$_GET['Newsletter']['email'];
            $model->has_select=$_GET['Newsletter']['has_select'];
            $model->time=$_GET['Newsletter']['time'];
