...
<script type="text/javascript">
    ...
    $(function()
    {
        ...
        if(profileimage)
            {
            $("#show_thumb").children('div.jt').after("<div class=upload_thumb><input type='hidden' value='"+profileimage+"' name='img_name_val[]' id='img_name_val'><a href='javascript:void(0)'><img name="+profileimage+" src='"+base_url+"/uploads/user_image/thumb/"+profileimage+"' style='max-height:150px;max-width:150px;border:solid 1px #979797'></a><img class='closeImg2' src='"+base_url+"/images/closebtn.png' title='Close Image' alt='ss' style='margin:-140px 0 0 -20px;' onclick='removeImage(this)'><br /><input type='button' style='width:80px; border:1px solid #D88C00; box-shadow:0 0 3px #BCBCBC; text-shadow:1px 0px 0px #333; box-shadow:0 1px 3px #fff; margin:5px 0 15px -2px; border:none; font: italic bold 18px/35px Arial,Helvetica,sans-serif; border:none; color:#fff; background:#69A905; height: 35px; border-radius:25px; padding: 0 0 0; text-align: center; text-transform: uppercase; width: 157px;' onclick=crop_image('"+profileimage+"') value='Crop'></div><div class='clear:both'></div>");
...
<h2 id="pageTitle">Add Category</h2>
