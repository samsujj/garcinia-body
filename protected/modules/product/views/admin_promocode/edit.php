<div id="main">
    <div id="content">
<h2 id="pageTitle">Edit Promo Code</h2>
...
'code_text',
array(
'append' => '<a href="javascript:void(0);" id="coderefresh" style="margin-top:1px;"><img src="'.$this->module->getAssetsUrl().'/images/refresh.png" ></a>'
)
); ?>
...
$this->widget(
'bootstrap.widgets.TbButton',
array('buttonType' => 'link','url'=>Yii::app()->baseurl.'/product/admin/promocode/listing', 'label' => 'Cancel')
); ?>
