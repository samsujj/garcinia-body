        ...
        <tr>
          <td colspan="2" style="font-size:12px; color:#333; "><table width="auto" border="0" cellspacing="0" cellpadding="0">
              ...
              <tr>
                ...
                <td width="30" style="padding:5px; border-bottom:solid 1px #ccc;"><strong>AutoShip</strong></td>
              </tr>
              ...
              <tr>
                ...
                if($autoship[$pro['product_id']] == 1){
                 echo number_format($pro['product_quantity']*$pro['product_price'], 2, '.', '');
                    ...
                    echo number_format($pro['product_quantity']*$proprice, 2, '.', '');
                }
                ?>
                 </td>
                <td width="30" style="padding:5px; border-bottom:solid 1px #ccc;"><?php ($autoship[$pro['product_id']] == 1)?'Yes':'No';?></td>
              </tr>
              <?php
        }
?>
          ...
          <td colspan="2" style="font-size:12px;background:#1a5f88; border:solid 1px #2FAAEB; padding:10px; color:#333;"><table width="600" border="0" cellspacing="0" cellpadding="0">
              ...
              <tr>
                <td width="316" style="border-right:dotted 1px #fff; padding:0px; color:#fff;"><strong>Shipping Address :</strong><br />
                  ...
                  <?php echo $order_ship_bill_details['shipping_add'].','.$order_ship_bill_details['shipping_city'].'-'.$order_ship_bill_details['shipping_zip'].','.Common::getStatename($order_ship_bill_details['shipping_state']).','.Common::getCountryname($order_ship_bill_details['shipping_country']);?></td>
