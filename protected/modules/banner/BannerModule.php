                ...
                public function getAssetsUrl()
    {
        if ($this->_assetsUrl === null)
            $this->_assetsUrl = Yii::app()->getAssetManager()->publish(
                Yii::getPathOfAlias('banner.assets') );
        return $this->_assetsUrl;
    }
    
    protected function registerScript(){
        $js_arr = array('common.js','jquery.uploadify.min.js','facebox.js','image_upload.js'); //put what js file name that you need to import from admin assets folder
        Yii::app()->assetManager->publish(Yii::getPathOfAlias('banner.assets'), false, -1, YII_DEBUG);
